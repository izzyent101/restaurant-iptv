...
class CategoryAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.text.setTextColor(if (holder.text.isFocused) 0xFF111418.toInt() else 0xFFF2F5F8.toInt())
        ...
        holder.text.setOnFocusChangeListener { _, hasFocus ->
            holder.text.setTextColor(if (hasFocus) 0xFF111418.toInt() else 0xFFF2F5F8.toInt())
            if (hasFocus) {
                val pos = holder.bindingAdapterPosition
